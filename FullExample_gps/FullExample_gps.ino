...
void loop()
{
  ...
  lcd2.clear();
   ...
   lcd2.setCursor(0, 0);
  lcd2.print("GPS  Values ");
  
  // lcd2.setCursor(0, 1);
  lcd2.print(gps.satellites.value());
  
  lcd2.setCursor(0 , 1);
  lcd2.print("Is GPS  Valid ");
  lcd2.print(gps.satellites.isValid());
  // lcd2.setCursor(0, 3);


 lcd2.setCursor(0 , 3);
 lcd2.print("A DustDevils Product ");
