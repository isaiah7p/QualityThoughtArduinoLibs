...
compAngleY = (0.93*(compAngleX+(gyroYrate*(double)(micros()-timer)/1000000)))+(0.07*accYangle); // Calculate the angle using a Complimentary filter
...
Serial.print("dustdevils X Pos: ");
Serial.print(moveX);Serial.print("\t");
Serial.print("dustdevils Y Pos: ");
