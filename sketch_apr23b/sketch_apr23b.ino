...
const char* ssid = "QualityThought1";             // Your local WiFi SSID (the network name you connect to)
const char* ssid_password = "quality@qt";  // YOur local SSID password
const char* s3endpoint = "qualitythought-iot.s3.amazonaws.com"; // WARNING: S3 Bucket names must be unique across all AWS S3 buckets 
WiFiClient client;
