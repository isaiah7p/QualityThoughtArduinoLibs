...
void setupBlueToothConnection()
{
  ...
  sendATCommand("BIND=001D,A5,1B227A");    //send BIND=??, bind HC-05 to OBD bluetooth address
  sendATCommand("INIT");                   //send INIT, cant connect without this cmd 
  delay(1000); 
  sendATCommand("PAIR=001D,A5,1B227A,20"); //send PAIR, pair with OBD address
  delay(1000);  
  sendATCommand("LINK=001D,A5,1B227A");    //send LINK, link with OBD address
  delay(1000); 
