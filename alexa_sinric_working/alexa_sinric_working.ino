...
#define MyApiKey "7b2a9f5d-f0dd-442d-bb92-69f8e63bc0d2" // TODO: Change to your sinric API Key. Your API Key is displayed on sinric.com dashboard
#define MySSID "Quality Thought 605B" // TODO: Change to your Wifi network SSID
#define MyWifiPassword "b4b3c69b" // TODO: Change to your Wifi network password

#define API_ENDPOINT "http://sinric.com"
#define HEARTBEAT_INTERVAL 300000 // 5 Minutes 
#define lightLED 4   // gpio4 - d2
#define doorLock 5   // gpio5 - d1 
#define regulatorGas 0  // gpio0-D3 
#define exhaustFan 2  // gpio2 - D4 
...
void turnOn(String deviceId) {
  if (deviceId == "5d256368e7f3e734db10d0a7") // Device ID of first device
  {  
  ...
  else if (deviceId == "5cb1c063326ee60ba5f1673e") // Device ID of second device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
  ...
  else if (deviceId == "5d2563a2e7f3e734db10d0bc") // Device ID of second device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
     digitalWrite(doorLock,HIGH);
  }
 else if (deviceId == "5d256456e7f3e734db10d0c4") // Device ID of second device
  { 
    Serial.print("Turn on device id: ");
    Serial.println(deviceId);
...
void turnOff(String deviceId) {
   ...
   else if (deviceId == "5d256381e7f3e734db10d0b2") // Device ID of second device
   { 
     Serial.print("Turn off Device ID: ");
     Serial.println(deviceId);
