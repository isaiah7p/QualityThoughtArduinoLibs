...
const char* ssid = "DustDevils"; // your connection name
const char* password = "b4b3c69bb4b3c69b5267!"; // your connection password
...
void handleRoot(){
  ...
  content += "<br><p><marquee direction='right'>Developed by   Quality Thought  </marquee></p>";
  content += "<br><br><br><br> <footer><p>Posted by: Isaiah Kumar Peram </p><p><a href=\"mailto:someone@example.com\">isaiah.ibm@gmail.com</a>.</p></footer></body>"; 
