...
char http_cmd[] = "GET dctdigitalsolutions.com/wiki/images/1/15/Hello.txt HTTP/1.0\r\n\r\n";
char buffer[512];
...
void setup() {
  ...
  Serial.println("Init success, connecting to dctdigitalsolutions.com ...");
  
  if(0 == gprs.connectTCP("dctdigitalsolutions.com", 80)) {
