...
void loop() 
{
  ...
  //  if(menuOption == '1') {
    ...
    delay(10);
    Serial.print(F("Distance 1: ")); Serial.print(hcsr04_1Dist); Serial.println(F("[cm]"));
    ...
    delay(10);
    Serial.print(F("Distance 2: ")); Serial.print(hcsr04_2Dist); Serial.println(F("[cm]"));
