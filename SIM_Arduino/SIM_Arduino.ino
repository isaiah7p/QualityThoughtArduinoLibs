...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"+919676867575\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
...
void DialVoiceCall()
{
  mySerial.println("ATD + +919676867575;");//dial the number
  delay(100);
  mySerial.println();
}
