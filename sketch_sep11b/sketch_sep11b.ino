...
/// Testing nokia 5110 lcd with nano 
///
#define PIN_RESET 4 //0Pin 4 no LCD

#define PIN_SCE   3 //Pin 3 no LCD

#define PIN_DC    2 //Pin 5 no LCD

#define PIN_SDIN  1 //Pin 6 no LCD
